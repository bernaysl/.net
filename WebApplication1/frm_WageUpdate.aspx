<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_WageUpdate.aspx.cs" Inherits="WebApplication1.frm_WageUpdate" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="GridView1" runat="server" Height="16px" Width="499px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Wage_ID" DataSourceID="SqlDataSource2">
                        <Columns>
